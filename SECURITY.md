...
The current release does not implement a public relay, remote dashboard, rooted radio toggle, traffic interception, or SOCKS UDP. Reports that require unsupported deployment modes may be treated as feature requests unless they affect a documented security boundary.
